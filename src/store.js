...
export const store = createStore({
	state: {
		...
		sortDesc: false,
		csMap: {
			'isin': {label: 'ISIN', class: ''},
			'comp': {label: '發行者', class: ''},
			'name': {label: '債券名稱', class: ''},
			'currency': {label: '幣別', class: ''},
			'sellPrice': {label: '參考<br>賣價', isNumber: true, class: 'text-align-right'},
			'buyPrice': {label: '參考<br>買價', isNumber: true, class: 'text-align-right'},
			'yield': {label: '到期<br>殖利率', isNumber: true, class: 'text-align-right'},
			'redemptionYear': {label: '距買<br>回年', isNumber: true, class: 'text-align-right'},
			'endYear': {label: '距到<br>期年', isNumber: true, class: 'text-align-right'},
			'rating1': {label: '穆迪', class: 'text-align-center'},
			'rating2': {label: '標普', class: 'text-align-center'},
			'rating3': {label: '惠譽', class: 'text-align-center'},
			'couponRate': {label: '票息', isNumber: true, class: 'text-align-right'},
			'couponCount': {label: '配息<br>次數', isNumber: true, class: 'text-align-center'},
			'nextPaymentDate': {label: '下一配息日', class: ''},
			'riskLevel': {label: '風險等級', class: ''},
			'repaymentOrder': {label: '償債順位', class: ''},
